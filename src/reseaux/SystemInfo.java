...
public class SystemInfo {
    ...
    public static void main(String[] args) {
        System.out.println("NOM DE L'ORDINATEUR : "+getSystemName());
        System.out.println("ADRESSE IP DE L'ORDINATEUR   : "+getIPAddress());
        System.out.println("ADRESSE MACHINE DE L'ORDINATEUR : "+getMAC());
    }
