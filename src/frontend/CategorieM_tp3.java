 ...
 * @author hp
 */
public class CategorieM_tp3 extends javax.swing.JFrame {
    ...
    public Component getTableCellRendererComponent(JTable table,
     ...
     // System.out.println("Connecting to database...");
      ...
      ResultSet rs = null ;
       ...
       sql = "SELECT * FROM categorie order by description asc" ;
   ...
   // System.out.println("Goodbye!");
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "CATEGORIE", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 18))); // NOI18N
        ...
        rech.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(4, 4, 4)
                .addComponent(rech, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     // System.out.println("Connecting to database...");
      ...
      if(stmt.executeUpdate("insert into categorie(description , ratio, type) "
   ...
   // System.out.println("Goodbye!");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
     ...
     // System.out.println("Connecting to database...");
      ...
      if(stmt.executeUpdate("update categorie set description = '"+desc+"' , ratio = '"+ratio+"' where id_cat = "+this.id) >= 0){
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
     ...
     // System.out.println("Connecting to database...");
      ...
      if(this.type.equalsIgnoreCase("OUI")){
          ...
          stmt.executeUpdate("update categorie set type = 'NON' where id_cat = "+this.id) ;
          
      }else if(this.type.equalsIgnoreCase("NON")){
          
          stmt.executeUpdate("update categorie set type = 'OUI' where id_cat = "+this.id) ;
   ...
   // System.out.println("Goodbye!");
     ...
     // System.out.println("Connecting to database...");
      ...
      ResultSet rs = null ;
       ...
       sql = "SELECT * FROM categorie where description like '%"+rech+"%' order by description asc" ;
   ...
   // System.out.println("Goodbye!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CategorieM_tp3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CategorieM_tp3().setVisible(true);
            }
        });
    }
