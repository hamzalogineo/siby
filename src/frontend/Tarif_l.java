 ...
 * @author hp
 */
public class Tarif_l extends javax.swing.JFrame {
    ...
    public Component getTableCellRendererComponent(JTable table,
     ...
     // System.out.println("Connecting to database...");
      ...
      ResultSet rs = null ;
       ...
       sql = "SELECT * FROM t_l order by description asc" ;
     ...
     while(rs.next()){
        ...
        // "ref.produit", "Code Barre", "Description", "Prix Achat", "Prix vente"
           ...
           rs.getString("id") , rs.getString("description") , rs.getString("etat") , rs.getInt("prix")
   ...
   // System.out.println("Goodbye!");
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "TARIF DE LIVRAISON", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 18))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     // System.out.println("Connecting to database...");
      ...
      if(stmt.executeUpdate("insert into t_l(description , prix , etat) "
              + "values('"+desc+"' , "+prix+", 'OUI')") == 1){
     ...
     while(rs.next()){
      ...
      this.desc.setText("") ; this.prx.setText("");
   ...
   // System.out.println("Goodbye!");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(desc.isEmpty() || this.jTable1.getSelectedRow() == -1 || prx.isEmpty()){
            JOptionPane.showMessageDialog(this, "PARAMETRE INCORRECT") ;
        }else{
     ...
     // System.out.println("Connecting to database...");
      ...
      if(stmt.executeUpdate("update t_l set description = '"+desc+"' , prix = "+(Integer.parseInt(prx))+" where id = "+this.id) == 1){
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
     ...
     // System.out.println("Connecting to database...");
      ...
      if(this.type.equalsIgnoreCase("OUI")){
          ...
          stmt.executeUpdate("update t_l set etat = 'NON' where id = "+this.id) ;
          
      }else if(this.type.equalsIgnoreCase("NON")){
          
          stmt.executeUpdate("update t_l set etat = 'OUI' where id = "+this.id) ;
   ...
   // System.out.println("Goodbye!");
     ...
     // System.out.println("Connecting to database...");
      ...
      ResultSet rs = null ;
       ...
       sql = "SELECT * FROM t_l where description like '%"+rech+"%' order by description asc" ;
   ...
   // System.out.println("Goodbye!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tarif_l.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
