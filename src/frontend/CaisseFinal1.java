 ...
 * @author HAMZA
 */
public class CaisseFinal1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CUMUL DES MATIERE  PRIMAIRE ET VENTE  ");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      ...
      sql = "SELECT condition_livraison as f , conservation as sf , cumul_v_mp.idpro as idpro , description as article , "
              + "prx_a_unite as pa , prx_v_unite as pu , sum(qte) , unite_mesure FROM "
              + "cumul_v_mp , matieres_p WHERE (cumul_v_mp.dtec BETWEEN '"+this.n1+"' AND '"+this.n2+"') "
              + " AND type = 1 AND matieres_p.id = cumul_v_mp.idpro group by idpro"  ;
    ...
    // "FAMILLES", "SOUS FAMILLES", "N°", "DESCRIPTION", "QTE UTILISEE.", "P.A", "P.U", "M.U", "PROFIT"
      ...
      sql2 = "SELECT f , sf , cumul_v_mp.idpro as idpro , description as article , sum(qte) , libelle as pa , pu , unite_m FROM cumul_v_mp , produits_f WHERE (cumul_v_mp.dtec BETWEEN '"+this.n1+"' AND '"+this.n2+"') "
              + " AND type = 0 AND produits_f.id = cumul_v_mp.idpro group by idpro" ;
    ...
    // "FAMILLES", "SOUS FAMILLES", "N°", "DESCRIPTION", "QTE UTILISEE.", "P.A", "P.U", "M.U", "PROFIT"
       ...
       rs2.getString("f") , rs2.getString("sf")  , rs2.getLong("idpro") , rs2.getString("article") , (rs2.getLong("sum(qte)")) ,
       rs2.getLong("pa") , rs2.getLong("pu") , nf3.format(Math.round(((rs2.getLong("sum(qte)"))/1000.0) * rs2.getLong("pa"))) , 
       nf3.format(Math.round(((rs2.getLong("sum(qte)"))/1000.0) * rs2.getLong("pu"))) ,
       nf3.format((Math.round(((rs2.getLong("sum(qte)"))/1000.0) * rs2.getLong("pu")) - Math.round(((rs2.getLong("sum(qte)"))/1000.0) * rs2.getLong("pa"))))
          
        }) ;
               
         pro += (Math.round(((rs2.getLong("sum(qte)"))/1000.0) * rs2.getLong("pu")) - Math.round((rs2.getLong("sum(qte)")/1000.0) * rs2.getLong("pa"))) ;
    ...
    // "FAMILLES", "SOUS FAMILLES", "N°", "DESCRIPTION", "QTE UTILISEE.", "P.A", "P.U", "M.U" , "PROFIT"
       ...
       rs2.getString("f") , rs2.getString("sf")  , rs2.getLong("idpro") , rs2.getString("article") , (rs2.getLong("sum(qte)")) ,
       rs2.getLong("pa") , rs2.getLong("pu") , nf3.format(((rs2.getLong("sum(qte)")) * rs2.getLong("pa"))) , 
       nf3.format(((rs2.getLong("sum(qte)")) * rs2.getLong("pu"))) ,
       nf3.format((((rs2.getLong("sum(qte)")) * rs2.getLong("pu")) - ((rs2.getLong("sum(qte)")) * rs2.getLong("pa"))))
          
        }) ;
               
         pro += (((rs2.getLong("sum(qte)")) * rs2.getLong("pu")) - ((rs2.getLong("sum(qte)")) * rs2.getLong("pa"))) ;
   ...
   //
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       ...
       // ici moi :
         ...
         try{
            ...
            ResultSet rs = statement.executeQuery("SELECT condition_livraison as f , conservation as sf , cumul_v_mp.idpro as idpro , description as article , "
              + "prx_a_unite as pa , prx_v_unite as pu , sum(qte) , unite_mesure FROM "
              + "cumul_v_mp , matieres_p WHERE (cumul_v_mp.dtec BETWEEN '"+this.n1+"' AND '"+this.n2+"') "
              + " AND type = 1 AND matieres_p.id = cumul_v_mp.idpro group by idpro ORDER BY f ASC, sf ASC, article ASC") ;
            
             ResultSet rs2 = statement1.executeQuery("SELECT f , sf , cumul_v_mp.idpro as idpro , description as article , sum(qte) , libelle as pa , pu , unite_m FROM cumul_v_mp , produits_f WHERE (cumul_v_mp.dtec BETWEEN '"+this.n1+"' AND '"+this.n2+"') "
              + " AND type = 0 AND produits_f.id = cumul_v_mp.idpro group by idpro ORDER BY f ASC , sf ASC , article ASC") ;
            ...
            while(rs2.next()){
                ...
                if("oui".equalsIgnoreCase(rs2.getString("unite_m"))){
                    ...
                    HashMap<String, Object> m = new HashMap<>(); 
                    m.put("idpro", rs2.getLong("idpro"));
                    m.put("article", rs2.getString("article"));
                    m.put("qte", (rs2.getLong("sum(qte)")));
                    m.put("pa", rs2.getLong("pa"));
                    m.put("pu", rs2.getLong("pu"));
                    m.put("f", rs2.getString("f"));
                    m.put("sf", rs2.getString("sf"));
                    m.put("tpa", Math.round((((rs2.getLong("sum(qte)"))/1000.0) * rs2.getLong("pa"))));
                    m.put("tpv", Math.round((((rs2.getLong("sum(qte)"))/1000.0) * rs2.getLong("pu"))));
                    m.put("marget", (Math.round(((rs2.getLong("sum(qte)"))/1000.0) * rs2.getLong("pu")) - Math.round(((rs2.getLong("sum(qte)"))/1000.0) * rs2.getLong("pa")))) ;
                    ...
                    m.put("f", rs2.getString("f"));
                    m.put("sf", rs2.getString("sf"));
                    m.put("tpa", ((rs2.getLong("sum(qte)")) * rs2.getLong("pa")));
                    m.put("tpv", ((rs2.getLong("sum(qte)")) * rs2.getLong("pu")));
                    m.put("marget", (((rs2.getLong("sum(qte)")) * rs2.getLong("pu")) - ((rs2.getLong("sum(qte)")) * rs2.getLong("pa"))));
        ...
        //  para.put("user", this.admin);
            ...
            para.put("au", this.n2) ;
            para.put("producteur", " ") ;
            para.put("cumul", "MATIERE ET VENTE") ;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CaisseFinal1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CaisseFinal1().setVisible(true);
            }
        });
    }
