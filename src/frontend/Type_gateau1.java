 ...
 * @author HAMZA
 */
public class Type_gateau1 extends javax.swing.JFrame {
    ...
    public Component getTableCellRendererComponent(JTable table,
     ...
     public Type_gateau1(String login) {
    ...
    public Component getTableCellRendererComponent(JTable table,
     ...
     // System.out.println("Connecting to database...");
      ...
      ResultSet rs = null ;
       ...
       sql = "SELECT * FROM t_gateau order by description asc" ;
     ...
     while(rs.next()){
        ...
        // "ref.produit", "Code Barre", "Description", "Prix Achat", "Prix vente"
           ...
           rs.getString("id") , rs.getString("description") ,  rs.getString("observation") , rs.getString("type")
   ...
   // System.out.println("Goodbye!");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(desc, javax.swing.GroupLayout.PREFERRED_SIZE, 278, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(88, 88, 88)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(observ, javax.swing.GroupLayout.PREFERRED_SIZE, 278, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(desc.isEmpty() || observ.isEmpty()){
     ...
     // System.out.println("Connecting to database...");
      ...
      if(stmt.executeUpdate("insert into t_gateau(description , observation , type) "
              + "values('"+desc+"' , '"+observ+"' , 'OUI')") == 1){
     ...
     while(rs.next()){
      ...
      this.desc.setText("") ; this.observ.setText("") ;
...
String type = "" ;
    private void jTable1MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseReleased
        ...
        this.observ.setText(this.jTable1.getValueAt(this.jTable1.getSelectedRow(), 2).toString()) ;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
     ...
     // System.out.println("Connecting to database...");
      ...
      if(stmt.executeUpdate("update t_gateau set description = '"+desc+"' , observation = '"+observ+"' where id = "+this.id) >= 0){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     // System.out.println("Connecting to database...");
      ...
      if(this.type.equalsIgnoreCase("OUI")){
          ...
          stmt.executeUpdate("update t_gateau set type = 'NON' where id = "+this.id) ;
          
      }else if(this.type.equalsIgnoreCase("NON")){
          
          stmt.executeUpdate("update t_gateau set type = 'OUI' where id = "+this.id) ;
   ...
   // System.out.println("Goodbye!");
     ...
     // System.out.println("Connecting to database...");
      ...
      ResultSet rs = null ;
       ...
       sql = "SELECT * FROM t_gateau where description like '%"+rech+"%' order by description asc" ;
   ...
   // System.out.println("Goodbye!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Type_gateau1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Type_gateau1().setVisible(true);
            }
        });
    }
