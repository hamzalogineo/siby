 ...
 * @author HAMZA
 */
public class ProductionPf extends javax.swing.JFrame {
    ...
    public ProductionPf() {
     ...
     public ProductionPf(Long idp , String role, String nomp) {
     ...
     // System.out.println("Connecting to database...");
      ...
      String sql ;
       ...
       sql= "SELECT * FROM produits_f ORDER BY description" ;
     ...
     while(rs.next()){
        ...
        // "CODE BARRE", "DESCRIPTION", "PRIX ACHAT", "PRIX DE VENTE"
            ...
            rs.getString("code_barre") , rs.getString("description") , rs.getLong("libelle") 
         ,  rs.getLong("pu")
  ...
  //     DefaultTableModel dtm1 = (DefaultTableModel) jTable2.getModel() ;
         ...
         sql1= "SELECT * FROM ppf WHERE idp = "+this.idp+" AND nomp = '"+this.nomP.replaceAll("'", "''")+"' ORDER BY article" ;
   ...
   // System.out.println("Goodbye!");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("LES PRODUITS FINI POUR LA PRODUCTION  ");
        ...
        jLabel10.setText("NOS PRODUITS FINI  :");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(desc1, javax.swing.GroupLayout.PREFERRED_SIZE, 251, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(cb1)))
                .addContainerGap())
            .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        aj.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        aj.setText("AJOUTER");
        ...
        sup.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
    ...
    private void desc1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_desc1KeyPressed
     ...
     // System.out.println("Connecting to database...");
      ...
      stmt = conn.createStatement();
        ...
        sql = "SELECT * FROM produits_f WHERE description LIKE '%"+d1+"%'" ;
    ...
    private void cb1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cb1KeyPressed
     ...
     // System.out.println("Connecting to database...");
      ...
      stmt = conn.createStatement();
       ...
       sql = "SELECT * FROM produits_f WHERE code_barre LIKE '%"+d1+"%'" ;
   ...
   // System.out.println("Goodbye!");
    ...
    private void ajActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ajActionPerformed
        ...
        if(this.jTable1.getSelectedRow() == -1){
         ...
         List entreprise = s.createSQLQuery("SELECT * FROM ppf WHERE idp = "+this.idp+" AND nomp = '"+this.nomP.replaceAll("'", "''")+"' AND article = '"+this.descD.replaceAll("'", "''")+"' ").list();
     ...
     if(stmt.executeUpdate("INSERT INTO ppf(idp,nomp,article,pa,pu,idpf) VALUES("+this.idp+", '"+this.nomP.replaceAll("'", "''")+"' , '"+this.descD.replaceAll("'", "''")+"' , "+this.pa+" , "+this.pv+" , "+this.idpf+" )" ) == 1){
         ...
         sql= "SELECT * FROM ppf WHERE idp ="+this.idp ;
     ...
     // System.out.println("Connecting to database...");
      ...
      stmt = conn.createStatement();
        ...
        // je crai ma requete
         ...
         sql= "SELECT * FROM ppf WHERE idp = "+this.idp+" AND nomp = '"+this.nomP.replaceAll("'", "''")+"' AND article LIKE '%"+d1.replaceAll("'", "''")+"%'" ;
     ...
     // System.out.println("Connecting to database...");
      ...
      stmt = conn.createStatement();
       ...
       clear2() ;
         ...
         sql= "SELECT * FROM ppf WHERE idp = "+this.idp+" AND nomp = '"+this.nomP.replaceAll("'", "''")+"' AND cb LIKE '%"+d1.replaceAll("'", "''")+"%'" ;
   ...
   // System.out.println("Goodbye!");
    ...
    private void supActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_supActionPerformed
     ...
     if(stmt.executeUpdate("DELETE FROM ppf WHERE idp = "+this.idp+"  AND article ='"+this.descSup.replaceAll("'", "''")+"'" ) == 1){
   ...
   // System.out.println("Goodbye!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProductionPf.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProductionPf().setVisible(true);
            }
        });
    }
