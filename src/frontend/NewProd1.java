 ...
 * @author HAMZA
 */
public class NewProd1 extends javax.swing.JFrame {
    ...
    public NewProd1(String login, String role) {
        this.setTitle("Nouvelle production");
        initComponents() ;
   ...
   // System.out.println("Goodbye!");
    ...
    //  debut en cours et fini 
           ...
           public NewProd1(String nom , Integer n ,String login, String role , Long ida) {
    ...
    public Component getTableCellRendererComponent(JTable table,
     ...
     // System.out.println("Connecting to database...");
      ...
      //je crai ma requete
       ...
       sql = "SELECT * FROM prod WHERE ( nom = '"+this.nom.replaceAll("'", "''")+"' OR ida = "+this.ida+" ) AND n = "+this.n ;
     ...
     String sql0 ;
       ...
       sql0 = "SELECT count(*) FROM prod WHERE ( nom = '"+this.nom.replaceAll("'", "''")+"' OR ida = "+this.ida+" ) AND status = 'ouverte'" ;
     ...
     ArrayList<String> prendre1 = new ArrayList<String>() ;
      ...
      // "Description", "QTE", "P.U", "Montant"
       ...
       sql8 = "SELECT article FROM prodmp WHERE ( nom = '"+this.nom.replaceAll("'", "''")+"' or ida = "+this.ida+" ) AND n = "+this.n+" GROUP BY article ORDER BY article asc" ;
  ...
  //   ArrayList<String> listempArticle = new ArrayList<>() ;
     ...
     while(rs2.next()){
       ...
       //  listempArticle.add(rs2.getString("article")) ;
         listemp.add(mp) ;
     ...
     String sql18 ;
      // "Description", "QTE", "P.U", "Montant"
       ...
       sql18 = "SELECT article FROM prodpf WHERE ( nom = '"+this.nom.replaceAll("'", "''")+"' OR ida = "+this.ida+" ) AND n = "+this.n+" GROUP BY article ORDER BY article asc" ;
     ...
     prendre1.removeAll(prendre1) ;
      ...
      String sql4 ;
      // "Description", "QTE", "P.U", "Montant"
       sql4 = "SELECT article , sum(qte) , pu , sum(montant) FROM prodmp WHERE ( nom = '"+this.nom.replaceAll("'", "''")+"' OR ida = "+this.ida+" ) AND n = "+this.n+" GROUP BY article ORDER BY article asc" ;
     ...
     this.dep.setText(String.valueOf(dep)) ;
      ...
      String sql5 ;
      // "Description", "QTE", "P.U", "Montant"
       sql5 = "SELECT article , sum(qte) , pa , sum(montant) FROM prodpf WHERE ( nom = '"+this.nom.replaceAll("'", "''")+"' OR ida = "+this.ida+" ) AND n = "+this.n+" GROUP BY article ORDER BY article asc" ;
     ...
     while(rs5.next()){
       ...
       rs5.getString("article") , rs5.getLong("sum(qte)") , rs5.getLong("pa") , rs5.getLong("sum(montant)")
 ...
 +jour+"' , 'production' , "+this.list_mp_newOp.get(i).getIdpro()+" , "+cb+")") ;
      ...
      String sql5 ;
      // "Description", "QTE", "P.U", "Montant"
       sql5 = "SELECT article , sum(qte) , pu , sum(montant) FROM prodpf WHERE ( nom = '"+this.nom.replaceAll("'", "''")+"' or ida = "+this.ida+" ) AND n = "+this.n+" GROUP BY article ORDER BY article asc" ;
   ...
   // rs.close() ;
    ...
    private void vprodActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_vprodActionPerformed
     ...
     // System.out.println("Connecting to database...");
      ...
      if(stmt.executeUpdate("UPDATE prod SET status = 'fermer' , dtef ='"+dtf+"' , dep = "+Long.parseLong(this.dep.getText().trim())+" , rec = "+Long.parseLong(this.rec.getText().trim())+" , profil = "+profil+" WHERE ( nom ='"+this.nom+"' or ida = "+this.ida+" ) AND n = "+this.n) == 1){
   ...
   // System.out.println("Goodbye!");
    ...
    private void nop1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nop1ActionPerformed
        ...
        if("".equals(qt) || "0".equals(qt)){
            ...
            if(qt10 < 0 && this.role.equalsIgnoreCase("ORDINAIRE") == false){
   ...
   // System.out.println("Goodbye!");
    ...
    private void nop2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nop2ActionPerformed
        ...
        if("".equals(qt) || "0".equals(qt) || this.product.getSelectedItem().toString().equalsIgnoreCase("CHOISIR PRODUCTEUR")){
            JOptionPane.showMessageDialog(this, "Saisir la quantité , producteur svp ") ;
        }else{
            long qt10 = 0 ;
            qt10 = Long.parseLong(qt) ;
   ...
   // System.out.println("Goodbye!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewProd1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
