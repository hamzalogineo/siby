...
public class NewProd extends javax.swing.JFrame {
    ...
    public NewProd(String login, String role) {
        this.setTitle("Nouvelle production");
        initComponents() ;
     ...
     while(rs.next()){
      ...
      this.activity.addItem(rs.getString("description")) ;  
       ...
       sql2 = "SELECT magasin FROM magasins where etat = 'oui' limit 1" ;
     ...
     while(rs2.next()){
          ...
          this.stock_1 = rs2.getString("magasin") ;
      ...
      // "ID", "Producteur / Groupe Producteur", "Date", "Utilisateur"
       sql3 = "SELECT * FROM productaire WHERE NOT type = 'oui' ORDER BY producteur ASC" ;
     ...
     if(this.etat == 1){
         ...
         this.jLabel30.setText("Bon auto.unique") ;
     }else if(this.etat == 0){
   ...
   // System.out.println("Goodbye!");
    ...
    //  debut en cours et fini 
           ...
           public NewProd(String nom , Integer n ,String login, String role) {
    ...
    public Component getTableCellRendererComponent(JTable table,
     ...
     while(rs.next()){
      ...
      this.dte.setText("DATE : "+sdf.format(rs.getDate("dtec")));
      this.op.setText("Operateur : "+rs.getString("admin"));
     ...
     while(rs2.next()){
       ...
       listemp.add(mp) ;
         ...
         if(listemp.get(i).getArticle().equalsIgnoreCase(prendre1.get(i).toString())){
     ...
     this.profit.setText(String.valueOf((Integer.parseInt(this.rec.getText()) - Integer.parseInt(this.dep.getText()))));
       ...
       sql22 = "SELECT * FROM magasins ORDER BY magasin" ;
     ...
     while(rs22.next()){
      ...
      String sql33 ;
      // "ID", "Producteur / Groupe Producteur", "Date", "Utilisateur"
       sql33 = "SELECT * FROM productaire ORDER BY producteur ASC" ;
   ...
   // System.out.println("Goodbye!");
    ...
    private void v1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_v1ActionPerformed
      ...
      //  JOptionPane.showMessageDialog(null, dc) ;
    ...
    List lib = s.createSQLQuery("SELECT * FROM prod WHERE ( nom ='"+this.nom+"' OR ida = "+this.ida+" ) AND n = "+this.n).list();
   ...
   //     je crai ma requete
       ...
       sql= "SELECT count(*) FROM histobon WHERE ( nom = '"+this.nom.replaceAll("'", "''")+"' OR ida = "+this.ida+" ) AND n = "+this.n+"" ;
     ...
     // System.out.println("Connecting to database...");
      ...
      //je crai ma requete
          ...
          if(cpt == 0){
              ...
              stmt.executeUpdate("INSERT INTO prod(nom,n,status,dtec,admin,dep,rec,profil,nb,grouper,etat,ida) VALUES('"+this.nom+"' , "+this.n+" , 'ouverte' , '"+dc+"' , '"+this.login.replaceAll("'", "''")+"' , 0 , 0 , 0 , "+0+" , '"+this.groupe.replaceAll("'", "''")+"' , 'NORMAL' , "+this.ida+" )") ;
   ...
   // rs.close() ;
     ...
     // Fin configure :
        ...
        this.v1.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR)) ;
                 ...
                 JOptionPane.showMessageDialog(this, "valider les produits fini d'abord ! ");
        }
 ...
 +jour+"' , 'matiere' , "+this.list_mp_newOp.get(i).getIdpro()+" , "+cb+")") ;
    ...
    private void v2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_v2ActionPerformed
        ...
        this.v2.setCursor(new java.awt.Cursor(java.awt.Cursor.WAIT_CURSOR)) ;
         ...
         if(this.product.getSelectedItem().toString().equalsIgnoreCase("CHOISIR PRODUCTEUR")){
             JOptionPane.showMessageDialog(null, "UN producteur") ;
        }else{
  ...
  stmt.executeUpdate("INSERT INTO histobon(nom,n,nbon,code_barre,op,dtec,total,ida) VALUES('"+this.nom+"' , "+this.n+" , "+nbon+" , "+cb+" , '"+this.login+"' , '"+dc+"' , "+0+" , "+this.ida+" )") ;                     
         ...
         stmt.executeUpdate("INSERT INTO prodpf(nom,n,article,qte,pu,montant,dtec,admin,f,sf,idpro,pa,profil,mu,producteur,ida) VALUES('"+this.list_mp_newOp.get(i).getNom()+"' , "+this.list_mp_newOp.get(i).getN()+" , '"+this.list_mp_newOp.get(i).getArticle().replaceAll("'", "''")+"' , "+this.list_mp_newOp.get(i).getQte()+" , "+this.list_mp_newOp.get(i).getPu()+" , "+this.list_mp_newOp.get(i).getMontant()+" , '"+dc+"' , '"+this.list_mp_newOp.get(i).getAdmin().replaceAll("'", "''")+"' , '"+this.list_mp_newOp.get(i).getF().replaceAll("'", "''")+"' , '"+this.list_mp_newOp.get(i).getSf().replaceAll("'", "''")+"' , "+this.list_mp_newOp.get(i).getIdpro()+" , "+this.list_mp_newOp.get(i).getPa()+" , "+0+" , "+0+" , "+this.idProduct+" , "+this.list_mp_newOp.get(i).getIda()+" )") ;                 
       //  stmt.executeUpdate("UPDATE stock1 SET  stock ="+this.list_mp_newOp.get(i).getStock()+" WHERE desi ='"+this.list_mp_newOp.get(i).getArticle().replaceAll("'", "''")+"' AND maga = '"+this.stock_1.replaceAll("'", "''")+"'") ;
         stmt.executeUpdate("INSERT INTO detailbon(nbon,code_barre,desi,qte,pu,mtt) VALUES("+nbon+" , "+cb+" , '"+this.list_mp_newOp.get(i).getArticle().replaceAll("'", "''")+"' , "+this.list_mp_newOp.get(i).getQte()+" , "+this.list_mp_newOp.get(i).getPu()+" , "+this.list_mp_newOp.get(i).getMontant()+")") ;                     
             // detail stock2 : 
   ...
   // rs.close() ;
     ...
     // Fin configure :
        ...
        this.v2.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR)) ;
            ...
            JOptionPane.showMessageDialog(this, "Vous devez valider les produits fini d'abord ! ") ;
        }
 ...
 +jour+"' , 'production' , "+this.list_mp_newOp.get(i).getIdpro()+" , "+cb+")") ;
   ...
   // System.out.println("Goodbye!");
    ...
    private void nop1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nop1ActionPerformed
        // TODO add your handling code here:
       /*
        ancien traitement correct for my rollback() ;
        ...
        */
        ...
        if("".equals(qt) || "0".equals(qt)){
               ...
               this.newStock = 0 ;
                   ...
                   if(this.stock1 >= qt10){
                       ...
                       double qt00 = 0.0 ;
                           ...
                           ProdmpList pmpl = new ProdmpList(this.nom, this.n, this.article, qt10, this.pu, this.montant, new Date(), this.login , this.f, this.sf, this.idpro, this.pa, this.profil, this.mu, this.newStock,this.ida, this.type) ;          
                       ...
                       }else if(qt10 < 0 && this.role.equalsIgnoreCase("ORDINAIRE") == false){
                       ...
                       double qt00 = 0.0 ;
                        ...
                        DefaultTableModel dtm1 = (DefaultTableModel) this.jTable1.getModel() ;
                           ...
                           JOptionPane.showMessageDialog(this, "NEGATIVE NON ACCEPTE") ;
                       }
         ...
         JOptionPane.showMessageDialog(this, "veillez reselectionner ou utiliser la touche entre pour selectionner vos produits svp");
            ...
            JOptionPane.showMessageDialog(this, "valider les produits fini d'abord svp !") ;
        }
        ...
        String act = this.activity.getSelectedItem().toString().replaceAll("'", "''") ;
         ...
         List lib1 = s.createSQLQuery("SELECT * FROM prod WHERE nom = '"+act.replaceAll("'", "''")+"' AND status = 'ouverte' AND dtec LIKE '%"+sdf10.format(new Date())+"%'").list() ;
           ...
           // Question :
                ...
                if (JOptionPane.showConfirmDialog(null, lib.size()+" ACTIVITE(S) "+act+" en cours, dont "+lib1.size()+" pour aujourd'hui : Voulez-vous continuer ?", "Demande",
    ...
    //     DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel() ;
     ...
     while(rs0.next()){
      ...
      String sql ;
       ...
       sql= "SELECT * FROM activite_t WHERE id = "+this.ida ;
     ...
     String sql1 = "" ;
      sql1 = "SELECT count(*) FROM prod WHERE ( nom = '"+this.nom+"' OR ida = "+this.ida+" ) " ;
     ...
     dtm1.setRowCount(0) ;
      ...
      String sql2 ;
       ...
       sql2 = "SELECT * FROM pmp WHERE (nomp = '"+this.nom.replaceAll("'", "''")+"' OR idp = "+this.ida+" ) GROUP BY article ORDER BY article ASC" ;
     ...
     dtm2.setRowCount(0) ;
      ...
      String sql3 ;
       ...
       sql3 = "SELECT * FROM ppf WHERE ( nomp = '"+this.nom.replaceAll("'", "''")+"' OR idp = "+this.ida+" ) GROUP BY article ORDER BY article" ;
    ...
    //     DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel() ;
     ...
     dtm1.setRowCount(0) ;
      ...
      String sql2 ;
       ...
       sql2 = "SELECT * FROM pmp WHERE ( nomp = '"+this.nom.replaceAll("'", "''")+"' OR idp = "+this.ida+" ) GROUP BY article ORDER BY article" ;
   ...
   // System.out.println("Goodbye!");
    ...
    //     DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel() ;
     ...
     while(rs1.next()){
       ...
       sql = "select description , stock_dispo, prx_pm , derive_pl.id as ref , produit from stock_pl , derive_pl where stock_pl.description = '"+this.jTable3.getValueAt(this.jTable3.getSelectedRow(), 0).toString().replaceAll("'", "''")+"' and derive_pl.produit = "
                + "stock_pl.description " ;
        rs = stmt.executeQuery(sql) ;
        while(rs.next()){
             
            dtm1.addRow(new Object[]{rs.getString("description"),"0",rs.getLong("prx_pm")}) ;
   ...
   // System.out.println("Goodbye!");
    ...
    private void jTable1MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseReleased
        ...
        if(this.stock_1.isEmpty()){
            JOptionPane.showMessageDialog(null, "ADMIN DOIT DECLARER UN MAGASIN PRINCIPAL !!! ") ;
        }else{
    ...
    //     DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel() ;
     ...
     sql = "select description , stock_dispo, prx_pm , derive_pl.id as ref , produit from stock_pl , derive_pl where stock_pl.description = '"+this.article.replaceAll("'", "''")+"' and derive_pl.produit = "
       ...
       sql2 = "SELECT stock FROM stock1 WHERE desi = '"+this.article.replaceAll("'", "''")+"' AND maga = '"+this.stock_1.replaceAll("'", "''")+"'" ;
    ...
    private void nop2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nop2ActionPerformed
               ...
               this.newStock = 0 ;
                 ...
                 if(qt10 > 0){
                       ...
                       double qt00 = 0.0 ;
                           ...
                           ProdmpList pmpl = new ProdmpList(this.nom, this.n, this.article, qt10, this.pu, this.montant, new Date(), this.login , this.f, this.sf, this.idpro, this.pa, this.profil, this.mu, this.newStock, this.ida) ;          
                                      this.list_mp_newOp.add(pmpl) ;
                                      this.vy = 2 ;
       ...
       this.profit.setText(String.valueOf( (Integer.parseInt(this.rec.getText()) - Integer.parseInt(this.dep.getText())) ) ) ;
         ...
         JOptionPane.showMessageDialog(this, "veillez reselectionner ou utiliser la touche entre pour selectionner vos produits svp");
            ...
            JOptionPane.showMessageDialog(this, "Vous devez valider les matieres primaires d'abord ! ") ;
        }
...
this.profit.setText(String.valueOf( (Integer.parseInt(this.rec.getText()) - Integer.parseInt(this.dep.getText())) ) ) ;
    ...
    private void jCheckBox1MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jCheckBox1MouseReleased
     ...
     if(stmt.executeUpdate("UPDATE config SET etat = 1 WHERE id = 1") == 1){
   ...
   // System.out.println("Goodbye!");
     ...
     if(stmt.executeUpdate("UPDATE config SET etat = 0 WHERE id = 1") == 1){
