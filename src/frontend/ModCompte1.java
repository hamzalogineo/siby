 ...
 * @author HAMZA
 */
public class ModCompte1 extends javax.swing.JFrame {
    ...
    public String getCuvNom() {
        return cuvNom;
    }

    public void setCuvNom(String cuvNom) {
        this.cuvNom = cuvNom;
    }

    public String getCuvLog() {
        return cuvLog;
    }

    public void setCuvLog(String cuvLog) {
        this.cuvLog = cuvLog;
    }
...
// fin :
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MODIFIER UN COMPTE UTILISATEUR :");
        ...
        rol.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "CHOISIR ROLE", "ORDINAIRE", "ADMINISTRATEUR", "SUPER ADMINISTRATEUR", "LOCATION", "ADMINII", "TP3 SIBY", "POINTAGE", "NOUVEAU LOGICIEL4", "NOUVEAU LOGICIEL5", "NOUVEAU LOGICIEL6", "NOUVEAU LOGICIEL7", "NOUVEAU LOGICIEL8", "NOUVEAU LOGICIEL9", "NOUVEAU LOGICIEL10" }));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jp.showMessageDialog(null," Les champs nom , login , mot de passe et role sont obligatoire ","Avertissement",JOptionPane.WARNING_MESSAGE) ;
         ...
         Session s=sf.openSession();
            ...
            ComptesU cu = new  ComptesU(this.id, n1, log1, mp1, rol1, tel1, status, this.dc, this.admin)  ;
            ...
            if(l.size() == 1 || ln.size() == 1){
                if(this.cuvNom.equalsIgnoreCase(n1) && this.cuvLog.equalsIgnoreCase(log1)){
        ...
        JOptionPane jp = new JOptionPane() ;
        jp.showMessageDialog(null," Le compte a ete modifie avec succes","Information",JOptionPane.INFORMATION_MESSAGE) ;
          ...
          JOptionPane jp = new JOptionPane() ;
     jp.showMessageDialog(null," Cet utilisateur est deja utiliser par un autre compte ","Avertissement",JOptionPane.WARNING_MESSAGE) ;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModCompte1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModCompte1().setVisible(true);
            }
        });
    }
