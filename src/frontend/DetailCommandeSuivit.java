 ...
 * @author HAMZA
 */
public class DetailCommandeSuivit extends javax.swing.JFrame {
    ...
    public DetailCommandeSuivit() {
     ...
     public DetailCommandeSuivit(long id , Integer cb) {
        initComponents();
        this.setLocationRelativeTo(null) ;
          ...
          try{
           ...
           sql = "select * from commande_client where id = "+this.id ;
            ...
            while(rs.next()){
             ...
             " TEL 1 : "+rs.getString("t1")+" TEL 2 : "+rs.getString("t2")+System.getProperty("line.separator")+
             " ADRESSE : "+rs.getString("adresse")+System.getProperty("line.separator")+" "
             +"ECRITURE SUR LE GATEAU : "+rs.getString("ecriture")
            
             ) ;
            
             this.info.setText(
                     
             "RDV : "+sdf.format(rs.getTimestamp("rdv"))+System.getProperty("line.separator")
             ...
             "DATE : "+sdf.format(rs.getTimestamp("jour"))+System.getProperty("line.separator")+
             ...
             " CONSIGNATION MOULE : "+rs.getString("moule")+System.getProperty("line.separator")+
             " OBSERVATION : "+rs.getString("observation")+System.getProperty("line.separator")+
             "GENRE GATEAU : "+rs.getString("g_gt")+System.getProperty("line.separator")+
             " OPERATEUR : "+rs.getString("login")+System.getProperty("line.separator")+
             "ACTIVER : "+rs.getString("etat")+System.getProperty("line.separator")+
             " MOTIF : "+rs.getString("motif")+System.getProperty("line.separator")+
            ...
            while(rs.next()){
                ...
                +"PRIX : "+nf3.format(rs.getInt("prx"))+" OBSERVATION : "+rs.getString("observation")) ;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DetailCommandeSuivit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DetailCommandeSuivit().setVisible(true);
            }
        });
    }
