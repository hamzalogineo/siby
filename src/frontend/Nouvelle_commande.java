 ...
 * @author HAMZA
 */
public class Nouvelle_commande extends javax.swing.JFrame {
    ...
    public Nouvelle_commande(String login) {
        initComponents();
        this.setLocationRelativeTo(null) ;
        this.setTitle("NOUVELLE COMMANDE") ;
...
if(this.cb_model == Integer.parseInt("0")){
 ...
 +etat+"' , '"+new String("")+"' , "+cb+" , '"+this.mode_payement+"')") ;
    ...
    // end :
     ...
     Nouvelle_commande nc = new Nouvelle_commande(this.login) ;
                       nc.setVisible(true) ;
...
Integer consigne = 0 ;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Nouvelle_commande.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Nouvelle_commande().setVisible(true);
            }
        });
    }
