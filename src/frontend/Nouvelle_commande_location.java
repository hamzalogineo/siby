 ...
 * @author HAMZA
 */
public class Nouvelle_commande_location extends javax.swing.JFrame {
    ...
    public Nouvelle_commande_location() {
        initComponents();
    ...
    public Nouvelle_commande_location(String login) {
        initComponents();
        this.setLocationRelativeTo(null) ;
        this.setTitle("NOUVELLE COMMANDE") ;
...
commande.get(i).getCl() , commande.get(i).getCb()
            ...
            String m1 = Nouvelle_commande_location.getDevis() ;
            ...
            Nouvelle_commande_location.setMtt(total); 
...
if(this.cb_model == Integer.parseInt("0")){
 ...
 +etat+"' , '"+new String("")+"' , "+cb+" , '"+this.mode_payement+"')") ;
    ...
    // end :
     ...
     Nouvelle_commande_location nc = new Nouvelle_commande_location(this.login) ;
                       nc.setVisible(true) ;
...
Integer consigne = 0 ;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Nouvelle_commande_location.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Nouvelle_commande_location().setVisible(true);
            }
        });
    }
