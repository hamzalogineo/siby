 ...
 * @author HAMZA
 */
public class UpdateTtProduitFiDelete extends javax.swing.JFrame {
    ...
    public UpdateTtProduitFiDelete() {
        initComponents();
      ...
      public UpdateTtProduitFiDelete(Long idActT , String act , String sql) {
        initComponents() ;
        this.setLocationRelativeTo(null);
        //this.setExtendedState(MAXIMIZED_BOTH);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
     ...
     // System.out.println("Connecting to database...");
      ...
      //je crai ma requete
           ...
           if(stmt.executeUpdate("UPDATE stocks_produit_fini SET stock_dispo = 0.0 WHERE produits_fini ='"+this.matp.replaceAll("'", "''")+"' AND stock_dispo > 0.0 LIMIT 1") == 1){
               
               if(stmt.executeUpdate("DELETE FROM transformation_t_produit_fini WHERE id = "+this.idT) == 1){
               
                            
                   
                           JOptionPane.showMessageDialog(this, "Suppression reussit avec succès");
   ...
   // System.out.println("Goodbye!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateTtProduitFiDelete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateTtProduitFiDelete().setVisible(true);
            }
        });
    }
