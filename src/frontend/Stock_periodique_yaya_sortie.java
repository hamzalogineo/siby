 ...
 * @author HAMZA
 */
public class Stock_periodique_yaya_sortie extends javax.swing.JFrame {
    ...
    public Stock_periodique_yaya_sortie() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "ETAT SORTIE STOCK SUR UNE PERIODE", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 3, 18))); // NOI18N
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "CODE BARRE", "DESCRIPTION", "QTE SORTIE", "P.A", "VALEUR STOCK ACHAT", "P.V", "VALEUR STOCK VENTE"
            }
        ) {
  ...
  //  "ID", "CODE BARRE", "DESCRIPTION", "QTE ENTREE", "P.A", "VALEUR STOCK ACHAT", "P.V", "VALEUR STOCK VENTE"
               ...
               sql = "select idpro,cb,desi,sum(qtest) as qte,pa,pv,unite_m as rp from stock2, produits_f where datec between '"+dte1+"' AND '"+dte2+"' "
                   + "AND type = 'sortie' AND et_ = 'oui' AND produits_f.description = stock2.desi "
                   + "group by stock2.f,stock2.sf,stock2.desi order by stock2.f,stock2.sf,stock2.desi" ;
               
               sql_1 = "select idpro,cb,desi,sum(qtest) as qte,pa,pv,unite_mesure as rp from stock2, matieres_p where datec between '"+dte1+"' AND '"+dte2+"' "
                   + "AND type = 'sortie' AND et_ = 'oui' AND matieres_p.description = stock2.desi "
                   + "group by stock2.f,stock2.sf,stock2.desi order by stock2.f,stock2.sf,stock2.desi" ;
               
               sql_0 = "select idpro,cb,desi,sum(qtest) as qte,pa,pv,produit as pr from stock2, derive_pl where datec between '"+dte1+"' AND '"+dte2+"' "
                   + " AND stock2.type = 'sortie' AND et_ = 'oui' AND derive_pl.produit = stock2.desi "
                   + "group by f,sf,desi order by f,sf,desi" ;
               
               
           }else if(mg.equals("TOUT") == false && f.equals("TOUTE") && sf.equals("TOUTE")){
               
                sql = "select idpro,cb,desi,sum(qtest) as qte,pa,pv,unite_m as rp from stock2, produits_f where "
                   + "maga = '"+this.mg.getSelectedItem().toString().replaceAll("'", "''")+"' AND "
                   + "datec between '"+dte1+"' AND '"+dte2+"' "
                   + "AND type = 'sortie' AND et_ = 'oui' AND produits_f.description = stock2.desi "
                   + "group by stock2.f,stock2.sf,stock2.desi order by stock2.f,stock2.sf,stock2.desi" ;
               
               sql_1 = "select idpro,cb,desi,sum(qtest) as qte,pa,pv,unite_mesure as rp from stock2, matieres_p where "
                      +"maga = '"+this.mg.getSelectedItem().toString().replaceAll("'", "''")+"' AND "
                      +"datec between '"+dte1+"' AND '"+dte2+"' "
                      +"AND type = 'sortie' AND et_ = 'oui' AND matieres_p.description = stock2.desi "
                      +"group by stock2.f,stock2.sf,stock2.desi order by stock2.f,stock2.sf,stock2.desi" ;
               
               sql_0 = "select idpro,cb,desi,sum(qtest) as qte,pa,pv,produit as pr from stock2, derive_pl where "
                       +"maga = '"+this.mg.getSelectedItem().toString().replaceAll("'", "''")+"' AND "
                       +"datec between '"+dte1+"' AND '"+dte2+"' "
                       +"AND stock2.type = 'sortie' AND et_ = 'oui' AND derive_pl.produit = stock2.desi "
                       +"group by f,sf,desi order by f,sf,desi" ;
 ...
 this.nf3.format(Math.round((rs.getLong("pa") * (rs.getLong("qte")/1000.0))))+"   "  , this.nf3.format(rs.getLong("pv"))+"   "  , this.nf3.format(Math.round((rs.getLong("pv") * (rs.getLong("qte")/1000.0))))+"   " 
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            para.put("titre","ETAT SORTIE STOCK SUR UNE PERIODE") ;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Stock_periodique_yaya_sortie.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Stock_periodique_yaya_sortie().setVisible(true);
            }
        });
    }
