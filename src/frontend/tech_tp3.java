 ...
 * @author hp
 */
public class tech_tp3 extends javax.swing.JFrame {
    ...
    public Component getTableCellRendererComponent(JTable table,
     ...
     // System.out.println("Connecting to database...");
      ...
      ResultSet rs = null ;
       ...
       sql = "SELECT * FROM technicien order by technicien asc" ;
     ...
     while(rs.next()){
        ...
        // "ref.produit", "Code Barre", "Description", "Prix Achat", "Prix vente"
           ...
           rs.getString("id_tech") , rs.getString("technicien") , rs.getString("contact"), rs.getString("metier"), rs.getString("type")
   ...
   // System.out.println("Goodbye!");
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "LISTE TECHNICIEN", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 18))); // NOI18N
        ...
        desc.setPreferredSize(new java.awt.Dimension(2, 20));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "TECHNICIEN", "CONTACT", "METIER", "TYPE"
            }
        ) {
        ...
        ratio.setPreferredSize(new java.awt.Dimension(2, 20));
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(0, 0, 0)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(mt, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     // System.out.println("Connecting to database...");
      ...
      if(stmt.executeUpdate("insert into technicien(technicien , contact, metier, type) "
              + "values('"+desc+"' , '"+ratio+"' , '"+mt+"' , 'OUI')") == 1){
     ...
     while(rs.next()){
      ...
      this.desc.setText("") ;  this.ratio.setText("") ;  this.mt.setText("") ;
   ...
   // System.out.println("Goodbye!");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
     ...
     // System.out.println("Connecting to database...");
      ...
      if(stmt.executeUpdate("update technicien set technicien = '"+desc+"' , contact = '"+ratio+"' , metier = '"+mt+"' where id_tech = "+this.id) >= 0){
...
String type;
    private void jTable1MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseReleased
        ...
        this.mt.setText(this.jTable1.getValueAt(this.jTable1.getSelectedRow(), 3).toString()) ;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
     ...
     // System.out.println("Connecting to database...");
      ...
      if(this.type.equalsIgnoreCase("OUI")){
          ...
          stmt.executeUpdate("update technicien set type = 'NON' where id_tech = "+this.id) ;
          
      }else if(this.type.equalsIgnoreCase("NON")){
          
          stmt.executeUpdate("update technicien set type = 'OUI' where id_tech = "+this.id) ;
   ...
   // System.out.println("Goodbye!");
     ...
     // System.out.println("Connecting to database...");
      ...
      ResultSet rs = null ;
       ...
       sql = "SELECT * FROM technicien where technicien like '%"+rech+"%' order by technicien asc" ;
   ...
   // System.out.println("Goodbye!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tech_tp3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
