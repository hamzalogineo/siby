...
public class Cmd extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "CUMUL CMD GATEAU", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 24))); // NOI18N
    ...
    private void rechActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rechActionPerformed
      ...
      sql = "SELECT gest_format.id as ref, detail_commande_client.description as produit , detail_commande_client.dimension as dim , "
          + "count(detail_commande_client.description) as qte , detail_commande_client.prx as prix , jour , rdv "
          + "FROM gest_format , detail_commande_client , commande_client  "
          + "WHERE  rdv BETWEEN '"+this.n1+"' AND '"+this.n2+"' AND etat = 'oui' AND detail_commande_client.cb = commande_client.cb "
          + "AND gest_format.description = detail_commande_client.description "
          + "group by detail_commande_client.description order by detail_commande_client.description ASC" ;
     ...
     // "GROUPE", "N°", "PRODUCTION", "Date D", "DATE F", "DEPENSE", "RECETTE", "PROFIT"
      ...
      // Deuxieme volet :
        ...
        sql = "SELECT model_gt.id as ref, detail_commande_client.description as produit , "
          + "count(detail_commande_client.description) as qte , detail_commande_client.prx as prix , jour , rdv "
          + "FROM model_gt , detail_commande_client , commande_client "
          + "WHERE  rdv BETWEEN '"+this.n1+"' AND '"+this.n2+"' AND etat = 'oui' AND detail_commande_client.cb = commande_client.cb "
          + "AND model_gt.cb = detail_commande_client.cb_model "
          + "group by detail_commande_client.description order by detail_commande_client.description ASC" ;
      ...
      while(rs.next()){
          ...
          to = (rs.getInt("qte") * rs.getInt("prix")) ;
           ...
           HashMap<String, Object> m = new HashMap<>() ;
                ...
                m.put("id", nf3.format(rs.getLong("ref"))) ;
                m.put("description", rs.getString("produit")) ;
                m.put("dim", "") ;
                m.put("qte", this.nf3.format(rs.getInt("qte"))) ;
                m.put("prix", this.nf3.format(rs.getInt("prix"))) ;
     ...
     // "GROUPE", "N°", "PRODUCTION", "Date D", "DATE F", "DEPENSE", "RECETTE", "PROFIT"
       ...
       rs.getLong("ref") , rs.getString("produit") , "" ,this.nf3.format(rs.getInt("qte")) , this.nf3.format(rs.getInt("prix")) , this.nf3.format(to) 
    ...
    private void impActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_impActionPerformed
        ...
        try{
            ...
            para.put("tete", "CUMUL COMMANDE GATEAU") ;
