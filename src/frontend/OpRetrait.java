 ...
 * @author HAMZA
 */
public class OpRetrait extends javax.swing.JFrame{
   ...
   // System.out.println("Goodbye!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OpRetrait.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
