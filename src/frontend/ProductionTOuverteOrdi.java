 ...
 * @author HAMZA
 */
public class ProductionTOuverteOrdi extends javax.swing.JFrame{
   ...
   // System.out.println("Goodbye!");
    ...
    public ProductionTOuverteOrdi( String nom , Integer n , String status , String dtec , String admin , String role) {
        initComponents();
        // this.role = role ;
   ...
   // System.out.println("Goodbye!");
    ...
    private void initComponents() {
        ...
        an20.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        an20.setText("VALIDER");
        an20.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                an20ActionPerformed(evt);
            }
        });
                                                ...
                                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                    ...
                                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                                        ...
                                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                                            ...
                                                            .addComponent(an20, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))))
                                        .addGap(1, 1, 1)))
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(an20, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(14, 14, 14)
...
if(stmt.executeUpdate("UPDATE stock1 SET qtest ="+qt02+" , stock ="+newStock+" WHERE desi ='"+this.article1.replaceAll("'", "''")+"'") > 0){
 ...
 if(stmt.executeUpdate("UPDATE stock1 SET qtest ="+qt02+" , stock ="+newStock+" WHERE desi ='"+this.article1.replaceAll("'", "''")+"'") > 0){
   ...
   // rs.close() ;
    ...
    private void an20ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_an20ActionPerformed
        // TODO add your handling code here:
   ...
   // rs.close() ;
    ...
    }//GEN-LAST:event_an20ActionPerformed
   ...
   //  System.out.println("Goodbye!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProductionTOuverteOrdi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProductionTOuverteOrdi().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton an20;
