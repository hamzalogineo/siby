 ...
 * @author HAMZA
 */
public class PointPlacement extends javax.swing.JFrame {
    ...
    public PointPlacement(String login){
        initComponents() ;
     ...
     // System.out.println("Connecting to database...");
      ...
      String sql ;
       ...
       sql= "SELECT * FROM point_pl ORDER BY placement ASC" ;
   ...
   // System.out.println("Goodbye!");
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Rechercher un point de placement");

        jLabel2.setText("POINT DE PLACEMENT");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        */
        ...
        if(rb.isEmpty() || "Rubrique".equalsIgnoreCase(rb)){
            JOptionPane.showMessageDialog(this, "Saisir le point de placement svp !");
        }else{
     ...
     // System.out.println("Connecting to database...");
      ...
      //je crai ma requete
        ...
        if(stmt.executeUpdate("insert into point_pl(placement,type) VALUES('"+rb+"' , 'oui')") == 1){
            this.rb.setText("");
            DefaultTableModel dtm1 = (DefaultTableModel) this.jTable1.getModel() ;
            dtm1.setRowCount(0) ;
  ...
  String etat = "" ;
    ...
    private void jTable1MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseReleased
        ...
        this.old_point = this.rb1.replaceAll("'", "''") ;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
     ...
     // System.out.println("Connecting to database...");
      ...
      //je crai ma requete
        ...
        if(stmt.executeUpdate("update point_pl SET placement = '"+rb+"' WHERE id = "+this.id) == 1){
            
                                    
stmt.executeUpdate("update op_pl_f set arriver = '"+rb+"' where arriver = '"+this.old_point+"'") ;
stmt.executeUpdate("update op_pl_f set depart = '"+rb+"' where depart = '"+this.old_point+"'") ;
stmt.executeUpdate("update detail_pl set arriver = '"+rb+"' where arriver = '"+this.old_point+"'") ;
stmt.executeUpdate("update detail_pl set depart = '"+rb+"' where depart = '"+this.old_point+"'") ;
stmt.executeUpdate("update stock_detail_pl set arriver = '"+rb+"' where arriver = '"+this.old_point+"'") ;
stmt.executeUpdate("update stock_detail_pl set depart = '"+rb+"' where depart = '"+this.old_point+"'") ;
stmt.executeUpdate("update stock_pl set magasin = '"+rb+"' where magasin = '"+this.old_point+"'") ;
stmt.executeUpdate("update facture_fourni set ref_saisie = '"+rb+"' where ref_saisie = '"+this.old_point+"'") ;
    ...
    private void jTextField2KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField2KeyReleased
     ...
     // System.out.println("Connecting to database...");
      ...
      //je crai ma requete
       ...
       sql= "SELECT * FROM point_pl WHERE placement LIKE '%"+this.jTextField2.getText().trim().replaceAll("'", "''")+"%' ORDER BY placement ASC" ;
   ...
   // System.out.println("Goodbye!");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
         ...
         if(this.jTable1.getSelectedRow() == -1 || this.etat.equalsIgnoreCase("")){
            JOptionPane.showMessageDialog(this, "Selectionner dans le tableau svp !") ;
            }else{        
     ...
     // System.out.println("Connecting to database...");
      ...
      if(this.etat.equalsIgnoreCase("oui")){
        ...
        if(stmt.executeUpdate("update point_pl SET type = 'non' WHERE id = "+this.id) == 1){
            DefaultTableModel dtm1 = (DefaultTableModel) this.jTable1.getModel() ;
            dtm1.setRowCount(0) ;
     ...
     rs.close();
           ...
           if(stmt.executeUpdate("update point_pl SET type = 'oui' WHERE id = "+this.id) == 1){
            DefaultTableModel dtm1 = (DefaultTableModel) this.jTable1.getModel() ;
            dtm1.setRowCount(0) ;
   ...
   // System.out.println("Goodbye!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PointPlacement.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PointPlacement().setVisible(true);
            }
        });
    }
