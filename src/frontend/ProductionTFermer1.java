...
import static frontend.ProductionTOuverte.JDBC_DRIVER;
 ...
 * @author HAMZA
 */
public class ProductionTFermer1 extends javax.swing.JFrame {
   ...
   // System.out.println("Goodbye!");
    ...
    public ProductionTFermer1(String nom , Integer n , String status , String dtec , String admin , String dtec2) {
        initComponents();
        this.setLocationRelativeTo(null);
        //this.setExtendedState(MAXIMIZED_BOTH);
        ...
        this.dtec2.setText("Fermer :"+" "+dtec2) ;
   ...
   // System.out.println("Goodbye!");
    ...
    private void initComponents() {
        ...
        jLabel14.setText("TOTAL DEPENSE : ");
        ...
        jLabel19.setText("TOTAL RECETTE :");

        rec.setEditable(false);
        rec.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        rec.setText("0");

        jLabel20.setText("LE PROFIL :");
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGap(34, 34, 34)
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(an2, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addComponent(ad2)))
                                    .addComponent(jPanel4, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGap(23, 23, 23)
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(an1, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addComponent(ad1))))
   ...
   // rs.close() ;
     ...
     // System.out.println("Connecting to database...");
      ...
      //je crai ma requete
         ...
         if(stmt.executeUpdate("INSERT INTO prod(nom,n,status,dtec,admin) VALUES('"+this.nom+"' , "+this.n+" , '"+this.st+"' , '"+this.dc+"' , '"+this.user_c.replaceAll("'", "''")+"')") == 1){
...
if(stmt.executeUpdate("UPDATE stock1 SET qtest ="+qt02+" , stock ="+newStock+" WHERE desi ='"+this.article1.replaceAll("'", "''")+"'") > 0){
   ...
   // rs.close() ;
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
       ...
       this.pv2 = Long.parseLong(jTable1.getValueAt(this.jTable1.getSelectedRow(), 1).toString()) ;
     ...
     // System.out.println("Connecting to database...");
      ...
      //je crai ma requete
         ...
         if(stmt.executeUpdate("INSERT INTO prod(nom,n,status,dtec,admin) VALUES('"+this.nom+"' , "+this.n+" , '"+this.st+"' , '"+this.dc+"' , '"+this.user_c.replaceAll("'", "''")+"')") == 1){
             ...
             if(stmt.executeUpdate("INSERT INTO prodpf(nom,n,article,qte,pu,montant,dtec,admin) VALUES('"+this.nom+"' , "+this.n+" , '"+this.article2.replaceAll("'", "''")+"' , "+qt02+" , "+this.pv2+" , "+mtt+" , '"+this.dc+"' , '"+this.user_c.replaceAll("'", "''")+"')") == 1){
   ...
   // rs.close() ;
     ...
     // Fin configure :
        ...
        //
                       ...
                       long qt03 = qt02 ;
                       double mtt04 = (this.pv2 * qt03) ;
                       double t4 = (this.mu2 * qt03) ;
                       
                       mtt = Math.round(mtt04) ;
   ...
   // System.out.println("Goodbye!");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
     ...
     // System.out.println("Connecting to database...");
      ...
      if(stmt.executeUpdate("UPDATE prod SET dep = "+Long.parseLong(this.dep.getText().trim())+" , rec = "+Long.parseLong(this.rec.getText().trim())+" , profil = "+profil+" WHERE nom ='"+this.nom+"' AND n = "+this.n) == 1){
          ...
          JOptionPane.showMessageDialog(this, "la production a été modifiée avec succès");
   ...
   // System.out.println("Goodbye!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProductionTFermer1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProductionTFermer1().setVisible(true);
            }
        });
    }
