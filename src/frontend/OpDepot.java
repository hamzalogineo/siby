 ...
 * @author HAMZA
 */
public class OpDepot extends javax.swing.JFrame{
   ...
   // System.out.println("Goodbye!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OpDepot.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
