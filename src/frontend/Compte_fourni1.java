 ...
 * @author HAMZA
 */
public class Compte_fourni1 extends javax.swing.JFrame {
    ...
    public Compte_fourni1(String user, String role){
        this.setTitle("OPERATIONS DE STOCK ");
        initComponents() ;
        this.setLocationRelativeTo(null) ;
   ...
   // System.out.println("Goodbye!");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("OPERATIONS DE STOCK");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "REF.SAISIE", "COMMENTAIRE", "DATE HEURE", "MONTANT", "UTILISATEUR", "ETAT", "SIBY ARS CB", "FOURNISSEUR"
            }
        ) {
     ...
     // System.out.println("Connecting to database...");
      ...
      //je crai ma requete
        ...
        */
        ...
        sql = "select facture_fourni.id as id ,ref_saisie,comt,datej,mtt,op,etat,cb,entreprise from facture_fourni , fournisseurs where ref_saisie like '%"+ref+"%' AND fournisseurs.id = facture_fourni.fourni order by facture_fourni.id desc" ;
        rs = stmt.executeQuery(sql) ;
        while(rs.next()){
     ...
     // System.out.println("Connecting to database...");
      ...
      //je crai ma requete
        ...
        */
        ...
        sql = "select facture_fourni.id as id ,ref_saisie,comt,datej,mtt,op,etat,cb,entreprise from facture_fourni , fournisseurs where datej BETWEEN '"+dte1+"' AND '"+dte2+"' AND fournisseurs.id = facture_fourni.fourni order by facture_fourni.id desc" ;
        rs = stmt.executeQuery(sql) ;
        while(rs.next()){
            // "ID", "REF.SAISIE", "COMMENTAIRE", "DATE HEURE", "MONTANT", "UTILISATEUR", "ETAT"
   ...
   // System.out.println("Goodbye!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Compte_fourni1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Compte_fourni1().setVisible(true);
            }
        });
    }
